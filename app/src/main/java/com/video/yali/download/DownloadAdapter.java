...
import com.video.yali.utils.FileFormatUtils;
...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind() {
            ...
            if (apk != null) {
                ...
                LogUtils.i("路径:" + path);
                Glide.with(context).load(apk.iconUrl).placeholder(R.drawable.default_cover_xhsp).error(R.drawable.default_cover_xhsp).into(icon);
        ...
        public void refresh(Progress progress) {
            String currentSize = FileFormatUtils.getPrintSize(progress.currentSize);
            String totalSize = FileFormatUtils.getPrintSize(progress.totalSize);
            ...
            switch (progress.status) {
                ...
                case Progress.LOADING:
                    String speed = FileFormatUtils.getPrintSize(progress.speed);
        ...
        @OnClick({R.id.icon, R.id.ll_video})
        public void play() {
            ...
            if (type == TYPE_FINISH) {
                LogUtils.i("下载路径:" + path + "==" + videoid);

                if (TextUtils.isEmpty(path)) {
                    ToastUtils.showLong(context.getString(R.string.filenotexists));
                    return;
                }
                ...
                intent.putExtra(GlobConstant.VIDEOTYPE, ConstantUtils.video_type_down);
                intent.putExtra(GlobConstant.VIDEOID, videoid);
                intent.putExtra(GlobConstant.VIDEOPATH, path);
    ...
    private class ListDownloadListener extends DownloadListener {
        ...
        public void onFinish(File file, Progress progress) {
            ...
            holder.priority.setText(progress.filePath);
            holder.getPath(progress.filePath);
            updateData(type);
        }
