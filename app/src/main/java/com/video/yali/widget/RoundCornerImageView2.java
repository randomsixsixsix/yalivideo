...
public class RoundCornerImageView2 extends AppCompatImageView {
    ...
    private int roundHeight = SizeUtils.dp2px(5);
    private int roundWidth = SizeUtils.dp2px(5);
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawLeftUp(canvas2);//左上角圆角
        drawRightUp(canvas2);//右上角圆角
       // drawLeftDown(canvas2);//左下角直角
     //   drawRightDown(canvas2);//右下角直角
